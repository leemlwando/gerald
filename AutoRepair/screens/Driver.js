...
export default class Driver extends Component {
  ...
  findPassengers() {
    if (!this.state.lookingForPassengers) {
      ...
      this.socket = socketIO.connect("http://192.168.42.62:3000");
  ...
  render() {
    ...
    let passengerSearchText = "FIND DRIVER 👥";
    ...
    if (this.state.lookingForPassengers) {
      passengerSearchText = "FINDING DRIVER...";
    ...
    if (this.state.passengerFound) {
      passengerSearchText = "FOUND DRIVER! ACCEPT JOB?";
